...
class AnalyzeTool(BaseTool):
    ...
    Example:
        ...
        >>> result = tool.execute(
        ...     query="What's the average revenue by category?",
        ...     datasets=["sales"]
        ... )
        >>> print(result["result"])
    """
            ...
            "properties": {
                "query": {
                    ...
                    "description": (
                        ...
                        "Examples: 'average revenue by category', 'top 5 customers by sales', "
            ...
            "properties": {
                "query": {
                    ...
                    "description": (
                        ...
                        "Examples: 'show revenue trend over time', 'bar chart of sales by category', "
