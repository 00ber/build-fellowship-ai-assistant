...
- [x] **Phase 1: Curriculum Documentation + Demo Infrastructure** - Document existing workshop structure, add narrative arc, build shared demo design system (completed 2026-02-17)
...
- [x] **Phase 3: Workshop 3 Materials (Agent Foundations)** - Build Behind the Curtain demo, revamp W3 notebook (completed 2026-02-24)
- [ ] **Phase 3.1: W3 Notebook Polish: Discovery Framing** - Restore "What if..." pedagogical arc to W3 notebook (INSERTED)
...
- [ ] 03-01-PLAN.md — Workshop 3 notebook Parts 1-4 (setup, LLM limitations, W2 bridge, function calling)
- [ ] 03-02-PLAN.md — Workshop 3 notebook Parts 5-8 (tools, agent v1-v4 evolution, ReAct pattern, W4 bridge)

### Phase 03.2: W3 Data Continuity: Connect structured extraction to agent tools (INSERTED)

**Goal:** Connect Part 3 structured extraction results to Part 4+ agent tools so extraction becomes the foundation that powers the agent tools, closing the data continuity gap
**Depends on:** Phase 3
**Plans:** 1 plan

Plans:
- [ ] 03.2-01-PLAN.md — Update extraction schema, add batch extraction, build bridge cell, update get_price_range, fix double dashes

### Phase 3.1: W3 Notebook Polish: Discovery Framing (INSERTED)

**Goal:** Restore the "What if..." pedagogical arc to the Workshop 3 notebook — shift framing, voice, and presentation to create a discovery-driven learning experience without changing content, scenario, or code
**Depends on:** Phase 3
**Plans:** 1 plan

Plans:
- [ ] 03.1-01-PLAN.md — Rewrite ~18 notebook cells for discovery-driven framing (intro, Part headers, Key Insights, ReAct payoff)
...
|-------|----------------|--------|-----------|
| 1. Curriculum Documentation + Demo Infrastructure | 3/3 | Complete    | 2026-02-17 |
| 2. Workshop 2 Materials (LLM Fundamentals & Prompt Engineering) | 0/TBD | Complete    | 2026-02-17 |
| 3. Workshop 3 Materials (Agent Foundations) | 0/TBD | Complete    | 2026-02-24 |
| 3.1 W3 Notebook Polish: Discovery Framing (INSERTED) | 0/TBD | Not started | - |
| 3.2 W3 Data Continuity (INSERTED) | 0/1 | Not started | - |
